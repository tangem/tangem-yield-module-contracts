...
contract EnterProtocolTest is AaveV3YieldModuleFixture {
    ...
    function test_enterProtocol_FirstEnter_SetsLatestFeePaymentState() public {
        ...
        _assertLatestFeePaymentState(yieldModule, TOTAL_ENTER_AMOUNT - NETWORK_FEE, SERVICE_FEE_RATE);
    }
    ...
    function testFuzz_enterProtocol_ConsecutiveEnter(uint revenue, uint newFeeRate) public {
        ...
        _assertLatestFeePaymentState(
            yieldModule, TOTAL_ENTER_AMOUNT + revenue + FRESH_OWNER_BALANCE - serviceFee - NETWORK_FEE, newFeeRate
        );
